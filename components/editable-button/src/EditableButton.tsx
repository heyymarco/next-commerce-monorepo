...
, { id: 'h5j3kpwec5' }); // a unique salt for SSR support, ensures the server-side & client-side have the same generated class names
...
const EditableButton = (props: EditableButtonProps) => {
    // styles:
